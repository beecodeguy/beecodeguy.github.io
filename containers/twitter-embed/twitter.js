...
export default function Twitter() {
    ...
    if (twitterDetails.userName) {
        return (React.createElement(Suspense, { fallback: renderLoader() },
            React.createElement("div", { className: "tw-main-div", id: "twitter" },
                React.createElement("div", { className: "centerContent" },
                    React.createElement(TwitterTimelineEmbed, { sourceType: "profile", screenName: twitterDetails.userName, options: { height: 400, width: { widthScreen } }, placeholder: renderLoader(), autoHeight: false, borderColor: "#fff", key: isDark ? "1" : "2", theme: isDark ? "dark" : "light", noFooter: true, onload: timeOut() })))));
    }
    else {
        return null;
    }
